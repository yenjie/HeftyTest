...
def _task1_benchmark(args: argparse.Namespace) -> int:
    run_task1_benchmark, _, _, _ = _import_task1_runners()
...
def _task1_publication_locked(args: argparse.Namespace) -> int:
    _, run_task1_publication_locked_benchmark, _, _ = _import_task1_runners()
...
def _task1_publication_smoothed(args: argparse.Namespace) -> int:
    _, _, run_task1_publication_smoothed_benchmark, _ = _import_task1_runners()
...
def _task1_tang_exact(args: argparse.Namespace) -> int:
    _, _, _, run_task1_tang_exact_benchmark = _import_task1_runners()
